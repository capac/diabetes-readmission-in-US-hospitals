...
def learning_curves_data(estimator, X, y, cv=5, train_sizes=train_sizes):
...
fig.tight_layout()
plt.savefig(work_dir / 'plots/learning_curves_plot_update.png', dpi=288, bbox_inches='tight')
